 ...
 */
public class OrQuery implements PropertyQuery {
    ...
    @Override
    public OrQuery prototype() {
        return this;
    }

    @Override
    public OrQuery prototype(Properties props) {
        return null;
    }
    ...
    protected void buildQuery(Collection<PropertyQuery> source) {
